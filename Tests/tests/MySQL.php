...
class MySQL_TestSuite extends TestSuite 
{
	private $db;
	...
	protected function test__query()
	{
		...
		gettype($result) == 'resource' || $this->error("Could not execute query '$query'");
	}
	...
	protected function test__table_info()
	{
		...
		(
			...
			'test' 		=> array('name' => 'test', 		'type' => 'varchar(255)', 			'real_type' => 'varchar', 	'max_length' => '255', 	'scale' => -1, 'null' => false, 'key' => 'PRI', 'default' => NULL, 'has_default' => false, 'extra' => '', 				'primary_key' => true, 	'unique' => true, 	'auto_increment' => false, 	'binary' => false, 'unsigned' => false, 'zerofill' => false),
