...
// Set this to false to compile everytime or clear $compiled_file to recompile
$read_compiled = true;
...
if($read_compiled && $compiledCss = file_get_contents($compiled_file)){ echo $compiledCss; exit; }
