...
session_name('FrameWorkSession');
session_start();

$_SESSION['iBrowser'] || exit;
	...
	/* $cfg['thumbs'] = array (
		...
		array ( 'size' => 1280, 	'ext' => '*', 	'crop' => false, ),
		array ( 'size' => 1024, 	'ext' => '*', 	'crop' => false, ),
		array ( 'size' => 640, 		'ext' => '*', 	'crop' => false, ),
		array ( 'size' => 512, 		'ext' => '*', 	'crop' => false, ),
		array ( 'size' => 400, 		'ext' => '*', 	'crop' => false, ),
		array ( 'size' => 400, 		'ext' => '*', 	'crop' => true, ),
		array ( 'size' => 120, 		'ext' => '*', 	'crop' => false, ),
		array ( 'size' => 75, 		'ext' => '*', 	'crop' => false, ),
	...
	*/
	...
	$cfg['ver'] 		= '1.3.8';										// iBrowser version
	...
	// BEGIN CUSTOM
	$cfg['root_dir']    = ((@$_SERVER['DOCUMENT_ROOT'] && file_exists(@$_SERVER['DOCUMENT_ROOT'] . $_SERVER['PHP_SELF'])) ? $_SERVER['DOCUMENT_ROOT'] : str_replace(dirname(@$_SERVER['PHP_SELF']), '', str_replace('\\', '/', realpath('.'))));
	$cfg['base_url'] 	= 'http://' . $_SERVER['HTTP_HOST'] . '/'; 							// base url; e.g. 'http://localhost/'
	$cfg['main_dir']    = strtr(dirname($_SERVER['PHP_SELF']), '//', '/');
	$cfg['scripts']  	= $cfg['main_dir'] . '/scripts/'; 								// scripts dir; e.g. '/home/domain/public_html/ibrowser/scripts/'
	$cfg['pop_url']    	= $cfg['scripts'] . 'popup.php'; 								// popup dir; relative to 'script' dir
	$cfg['temp']     	= realpath(dirname(__FILE__) . '/../temp');

	$cfg['thumbs'] = array
	(
		array ( 'size' => '*',  	'ext' => '*', 		'crop' => false ),
		array ( 'size' => 300, 		'ext' => '*', 		'crop' => false ),
		array ( 'size' => 100, 		'ext' => '*', 		'crop' => false )
	);

	$cfg['ilibs'] = array (
	//	array ( 'value' => '/assistancebulgaria/content/images/sections/', 		'text' => 'Sections' ),
		array ( 'value' => '/'.$_SESSION['iBrowser']['public'].'/files/ib_'.$_SESSION['iBrowser']['folder'].'/', 		'text' => $_SESSION['iBrowser']['folder'] )
	);
	
	/*
	$cfg['ilibs_dir'] 	   = array('/public/files/ib_'.$_SESSION['iBrowser']['folder']);
