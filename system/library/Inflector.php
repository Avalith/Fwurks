...
final class Inflector
{
	...
	public static function singularize($string)
	{
		...
		$uncountable = array('equipment', 'information', 'rice', 'money', 'species', 'series', 'sms' , 'rss');
	...
	public static function pluralize($string)
	{
		...
		$uncountable = array('equipment', 'information', 'rice', 'money', 'species', 'sms' , 'rss');
	...
	public static function to_slug($string)
	{
		...
		return $cache[$string] = trim( preg_replace('/[^a-zA-Z\d-]+/ui', '_', strtolower($string)), '_' );
	}
