...
class HtmlForm_FileField extends HtmlForm_SimpleField
{
	...
	protected $database = null; // file is saved in database and holds the model name
	...
	protected function file_type()
	{
		...
		return "<div class=\"file-type ".$this->extension()."\"><a href=\"{$url}\" target=\"_blank\">{$this->filename}</a></div>";
	}
