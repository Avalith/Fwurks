...
class HtmlForm_CheckboxListField extends HtmlForm_Field
{
	...
	protected $class_field_wrapper = 'checkbox-list';
	...
	public function field()
	{
		if($this->data)
		{
			...
			$counter = new HtmlForm_HiddenField(array('name' => 'ManyToManyCounter['.$this->name.']', 'value' => count($this->value), 'class' => 'many-to-many-counter'));
			$counter = $counter->html();
			$html .= "<div $class_field_wrapper>$counter<ul $id $class $lang $rel>";
