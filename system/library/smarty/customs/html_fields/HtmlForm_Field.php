...
abstract class HtmlForm_Field
{
	...
	public function helper()
	{
		if($this->helper)
		{
			$helper = Registry::$globals->HELPERS[$this->helper === true ? $this->name : $this->helper] ?: $this->helper;
			return "<strong class=\"$this->class_helper\" style=\"$this->style_helper\">{$helper}</strong>";
		}
		return null;
	}
