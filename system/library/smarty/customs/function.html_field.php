...
require_once dirname(__FILE__).'/html_fields/HtmlForm_Field.php';

function smarty_function_html_field($params, &$smarty)
{
	...
	require_once dirname(__FILE__).'/html_fields/'.$type.'.php';
