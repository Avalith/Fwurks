		...
		<div id="header">
			<div class="info">
				...
				<div class="right">
					...
					&nbsp;|&nbsp; -->
					<a href="{url for='/'}">Visit site</a>	&nbsp;|&nbsp;
					<a href="{url for='//administration/profile'}" title="User loged: {$__session->logged_user->_display_name}">{$__session->logged_user->_display_name}Username</a>
