...
final class Template_Config
{
	...
	const SECURITY_STATIC_CLASSES		= array();
	...
	const SECURITY_PHP_FUNCTIONS		= array('isset', 'empty', 'count', 'sizeof', 'in_array', 'is_array','time','nl2br', 'de');
	...
	const SECURITY_PHP_MODIFIERS		= array('escape','count');
	...
	const SECURITY_STREAMS				= array('file');
